...
export class SideMenuSection extends React.Component<SideMenuSectionDataProps, SideMenuSectionState> {
  ...
  private renderArticleLink = (nav: NavigationItem, key: number, parent: NavigationItem): JSX.Element => (
